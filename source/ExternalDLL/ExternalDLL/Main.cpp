...
int main(int argc, char * argv[]) {
	...
	ImageIO::debugFolder = "D:\\HU-Vision-1415-Base\\source\\ExternalDLL\\FaceMinMin";
	...
	if (!ImageIO::loadImage("D:\\HU-Vision-1415-Base\\testsets\\Set A\\TestSet Images\\child-1.png", *input)) {
